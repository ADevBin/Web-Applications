                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <li><a class="dropdown-item" href="card-container-Women-fashion.php">Women's Fashion</a></li>
                                            <li><a class="dropdown-item" href="card-container.php"> Electronics</a></li>
                                            <li><a class="dropdown-item" href="card-container-Beauty-Product.php"> Beauty Product</a></li>
                                            <li><a class="dropdown-item" href="card-container-Groceries.php"> Groceries</a></li>
                                            <li><a class="dropdown-item" href="card-container-Sneakers.php"> Sneaker's</a></li>
                                        </ul>
                                    </li>
                                    <li class="nav-item">
